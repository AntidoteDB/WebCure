...
Furthermore, in the \chapref*{Evaluation} we will cover the topic on how we evaluated the system, where we will also show WebCure running in a Calendar application. Finally, in the \chapref*{RelatedWork} we discuss other methods and technics that inspired us for this work. Then, in \chapref*{Conclusion} we will summarise the work of this thesis and in the \secref*{futurework} we will talk about any future improvements that can be done. 