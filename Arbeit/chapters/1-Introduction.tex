...
Having explained all the previous topics, in the \chapref*{Implementation}, we will go in details through the implementation of the system, starting discussing the main components of the system in the \secref*{sysmaincomponents}.
