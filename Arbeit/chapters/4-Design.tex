...
For this thesis, we are going to use such datatypes as Counters, Sets and Multi-Value Registers. As was already mentioned in the \chapref*{Introduction}, the counter is a number datatype, which allows incrementing and decrementing the value. Reading a counter will return the aggregated value of all performed operations.  
