...
First, let us have a look at the constructor of a \textit{SetCRDT} class at the \lstref*{lst:dev7}, which takes two parameters -- an \textit{id} and, optionally, an array of elements -- \textit{values}. The class has the following properties: 
