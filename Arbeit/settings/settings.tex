...
\NewDocumentCommand{\tableref}{s m}{\textbf{Table\textcolor{blue}{~\ref{#2}}}\IfBooleanF{#1}{ \nameref{#2}}}
\NewDocumentCommand{\secref}{s m}{\textbf{Section\textcolor{blue}{~\ref{#2}}}\IfBooleanF{#1}{ \nameref{#2}}}
