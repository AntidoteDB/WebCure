...
\addvspace {10\p@ }
\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {3.1}Pseudocode for requesting the data: client.}{15}{lstlisting.3.1}
\contentsline {lstlisting}{\numberline {3.2}Pseudocode for making a request to change the data: client.}{17}{lstlisting.3.2}
\contentsline {lstlisting}{\numberline {3.3}Pseudocode for sending offline performed operations to the server: client.}{18}{lstlisting.3.3}
\addvspace {10\p@ }
...
\contentsline {lstlisting}{\numberline {4.3}An example code, which demonstates a listener for the \textit {install} service worker's event\cite {32}.}{25}{lstlisting.4.3}
\contentsline {lstlisting}{\numberline {4.4}An example code, which demonstates a listener for the \textit {activation} service worker's event\cite {32}.}{25}{lstlisting.4.4}
\contentsline {lstlisting}{\numberline {4.5}An example code, which demonstrates how one can create cache storage called \textit {my-cache}\cite {34}.}{26}{lstlisting.4.5}
\contentsline {lstlisting}{\numberline {4.6}An example code, which demonstrates how one can check the support for IndexedDB API\cite {35}.}{27}{lstlisting.4.6}
\contentsline {lstlisting}{\numberline {4.7}An example code, which demonstrates how to register a sync (\textit {myFirstSync} here) event for the service worker\cite {38}.}{28}{lstlisting.4.7}
\contentsline {lstlisting}{\numberline {4.8}An example code, which demonstates that a function \textit {doSomeStuff} called, when the \textit {sync} event happened\cite {38}.}{29}{lstlisting.4.8}
\addvspace {10\p@ }
