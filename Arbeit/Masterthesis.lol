...
\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {4.1}An example code, which demonstrates how to register a service worker\cite {32}.}{25}{lstlisting.4.1}
\contentsline {lstlisting}{\numberline {4.2}An example code, which demonstrates how to set a custom scope when registering a service worker\cite {32}.}{26}{lstlisting.4.2}
\contentsline {lstlisting}{\numberline {4.3}An example code, which demonstates a listener for the \textit {install} service worker's event\cite {32}.}{27}{lstlisting.4.3}
\contentsline {lstlisting}{\numberline {4.4}An example code, which demonstates a listener for the \textit {activation} service worker's event\cite {32}.}{27}{lstlisting.4.4}
\contentsline {lstlisting}{\numberline {4.5}An example code, which demonstrates how one can create cache storage called \textit {my-cache}\cite {34}.}{28}{lstlisting.4.5}
\contentsline {lstlisting}{\numberline {4.6}An example code, which demonstrates how one can check the support for IndexedDB API\cite {35}.}{29}{lstlisting.4.6}
\contentsline {lstlisting}{\numberline {4.7}An example code, which demonstrates how to register a sync (\textit {myFirstSync} here) event for the service worker\cite {38}.}{30}{lstlisting.4.7}
...
\contentsline {lstlisting}{\numberline {7.3}The result of requesting the updated version of \textit {document}}{60}{lstlisting.7.3}
\contentsline {lstlisting}{\numberline {7.4}Updating the value of item \textit {document} by adding \textit {d} into it.}{61}{lstlisting.7.4}
\contentsline {lstlisting}{\numberline {7.5}The result of requesting the \textit {document} from CouchDB-1.}{61}{lstlisting.7.5}
\contentsline {lstlisting}{\numberline {7.6}The result of requesting the \textit {document} from CouchDB-2.}{61}{lstlisting.7.6}
