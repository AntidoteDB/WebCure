...
document.addEventListener("DOMContentLoaded", event => {
  ...
  DBHelper.crdtDBPromise.then(function(db) {
    ...
    var tx = db.transaction("participants-1", "readwrite");
    var store = tx.objectStore("participants-1");

    var item = new SetCRDT("users", []);
  ...
  DBHelper.crdtDBPromise.then(function(db) {
    ...
    var tx = db.transaction("participants-2", "readwrite");
    var store = tx.objectStore("participants-2");
